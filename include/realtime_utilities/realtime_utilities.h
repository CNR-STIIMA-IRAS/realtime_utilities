...
inline const char* BOLDBLACK()
{
  return "\033[1m\033[30m";
}
inline const char* BOLDRED()
{
  return "\033[1m\033[31m";
}
inline const char* BOLDGREEN()
{
  return "\033[1m\033[32m";
}
inline const char* BOLDYELLOW()
{
  return "\033[1m\033[33m";
}
inline const char* BOLDBLUE()
{
  return "\033[1m\033[34m";
}
inline const char* BOLDMAGENTA()
{
  return "\033[1m\033[35m";
}
inline const char* BOLDCYAN()
{
  return "\033[1m\033[36m";
}
inline const char* BOLDWHITE()
{
